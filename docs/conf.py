...
htmlhelp_basename = 'django-visitordoc'
...
latex_documents = [
  ('index', 'django-visitor.tex', u'django-visitor Documentation',
...
man_pages = [
    ('index', 'django-visitor', u'django-visitor Documentation',
